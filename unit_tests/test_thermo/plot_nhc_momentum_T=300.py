"""Plot NHC VRORV canonical phase-space distribution for a 1-D harmonic oscillator.

Data file: nhc_momentum_T=300.dat  (two columns: p  x)
Exact distributions:
    p ~ N(0, sqrt(m/beta))
...
fig.suptitle(
    f"NHC VRORV — 1-D HO canonical distribution  "
